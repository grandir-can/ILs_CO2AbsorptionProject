...
def train_evaluate_rf(feature_type='RDKit', target_property='Viscosity'):
    ...
    if feature_type == 'RDKit':
        with open('../../data/result/rdkit_features.pkl', 'rb') as f:
...
if __name__ == '__main__':
    train_evaluate_rf(feature_type='RDKit', target_property='Viscosity')
